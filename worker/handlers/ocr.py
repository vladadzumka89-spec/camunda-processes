...
- invoice_amount: ПОВНА сума з ПДВ (значення біля "Всього з ПДВ", "Разом з ПДВ", "Підсумок", "Total"). \
ВАЖЛИВО: НЕ використовуй "До сплати", "Сума до оплати", "Залишок до сплати", "Залишок" — це може бути менша сума через передоплату/аванс. \
Завжди бери ПОВНУ суму рахунку з ПДВ. Якщо є передоплата — ігноруй її, бери "Всього з ПДВ".
...
Кириличні літери В, І, Т, А, Е, Р, С, О, Н, Х, К, М, Р, У візуально схожі на латинські, але це РІЗНІ символи. \
Приклад: "ВІТА ВЕРІТАС" повертай як "ВІТА ВЕРІТАС", а не як "VITA VERITAC" чи "BITA VERITAC". \
Якщо назва в документі справді написана латиницею (англомовний бренд) — повертай латиницею.
